...
const PenaltyTable: React.FC = () => {
  ...
  return (
    <div className="w-full p-6">
      <h2 className="text-xl font-semibold mt-10 mb-6 text-center">
        📊 HR Dashboard - Penalty Summary
      </h2>
